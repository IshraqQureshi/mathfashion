<?php
	...
	if($vw_ecommerce_store_first_color != false){
		$vw_ecommerce_store_custom_css .='button.product-btn, .woocommerce #respond input#submit, .woocommerce a.button, .woocommerce button.button, .woocommerce input.button, .woocommerce #respond input#submit.alt, .woocommerce a.button.alt, .woocommerce button.button.alt, .woocommerce input.button.alt, span.cart-value, .search-box i, .serach_inner button, .products li:hover span.onsale, input[type="submit"], #footer .tagcloud a:hover, #sidebar .custom-social-icons i, #footer .custom-social-icons i, #footer-2, .scrollup i, #sidebar h3, .pagination .current, .pagination a:hover, #sidebar .tagcloud a:hover, #comments input[type="submit"], nav.woocommerce-MyAccount-navigation ul li, .woocommerce div.product span.onsale, .discount-btn a, #comments a.comment-reply-link, .toggle-nav i, #sidebar .widget_price_filter .ui-slider .ui-slider-range, #sidebar .widget_price_filter .ui-slider .ui-slider-handle, #sidebar .woocommerce-product-search button, #footer .widget_price_filter .ui-slider .ui-slider-range, #footer .widget_price_filter .ui-slider .ui-slider-handle, #footer .woocommerce-product-search button{';
			$vw_ecommerce_store_custom_css .='background-color: '.esc_html($vw_ecommerce_store_first_color).';';
		$vw_ecommerce_store_custom_css .='}';
	}
	if($vw_ecommerce_store_first_color != false){
		$vw_ecommerce_store_custom_css .='a, #topbar .custom-social-icons i:hover, .carousel-caption1 a:hover, .carousel-caption a:hover, .products li:hover h2, #footer .custom-social-icons i:hover, #footer li a:hover, .post-main-box:hover h2, .more-btn a:hover, #sidebar ul li a:hover, .post-navigation a:hover .post-title, .post-navigation a:focus .post-title, .main-navigation a:hover, .main-navigation ul.sub-menu a:hover, .entry-content a, .sidebar .textwidget p a, .textwidget p a, #comments p a, .slider .inner_carousel p a, .post-navigation a:hover, .post-navigation a:focus, #sidebar a.custom_read_more:hover, #footer a.custom_read_more:hover{';
			$vw_ecommerce_store_custom_css .='color: '.esc_html($vw_ecommerce_store_first_color).';';
		$vw_ecommerce_store_custom_css .='}';
	}
	if($vw_ecommerce_store_first_color != false){
		$vw_ecommerce_store_custom_css .='.carousel-caption1 a:hover, .carousel-caption a:hover, .more-btn a:hover, #sidebar a.custom_read_more:hover, #footer a.custom_read_more:hover{';
			$vw_ecommerce_store_custom_css .='border-color: '.esc_html($vw_ecommerce_store_first_color).';';
		$vw_ecommerce_store_custom_css .='}';
	}
	if($vw_ecommerce_store_first_color != false){
		$vw_ecommerce_store_custom_css .='#serv-section hr, .main-navigation ul ul{';
			$vw_ecommerce_store_custom_css .='border-top-color: '.esc_html($vw_ecommerce_store_first_color).';';
		$vw_ecommerce_store_custom_css .='}';
	}
	if($vw_ecommerce_store_first_color != false){
		$vw_ecommerce_store_custom_css .='#footer h3:after, .main-navigation ul ul, .header-fixed{';
			$vw_ecommerce_store_custom_css .='border-bottom-color: '.esc_html($vw_ecommerce_store_first_color).';';
		$vw_ecommerce_store_custom_css .='}';
	}
	if($vw_ecommerce_store_first_color != false){
		$vw_ecommerce_store_custom_css .='span.cart-value:before{';
			$vw_ecommerce_store_custom_css .='border-right-color: '.esc_html($vw_ecommerce_store_first_color).';';
		$vw_ecommerce_store_custom_css .='}';
	}
	...
	if($vw_ecommerce_store_slider_height != false){
		$vw_ecommerce_store_custom_css .='#slider img{';
			$vw_ecommerce_store_custom_css .='height: '.esc_html($vw_ecommerce_store_slider_height).';';
		$vw_ecommerce_store_custom_css .='}';
	}
	...
	$vw_ecommerce_store_res_slider = get_theme_mod( 'vw_ecommerce_store_resp_slider_hide_show',false);
    if($vw_ecommerce_store_res_slider == true){
    	$vw_ecommerce_store_custom_css .='@media screen and (max-width:575px) {';
		$vw_ecommerce_store_custom_css .='#slider{';
			$vw_ecommerce_store_custom_css .='display:block;';
		$vw_ecommerce_store_custom_css .='} }';
	}else if($vw_ecommerce_store_res_slider == false){
		$vw_ecommerce_store_custom_css .='@media screen and (max-width:575px) {';
		$vw_ecommerce_store_custom_css .='#slider{';
			$vw_ecommerce_store_custom_css .='display:none;';
		$vw_ecommerce_store_custom_css .='} }';
    ...
    if($vw_ecommerce_store_resp_scroll_top == true){
		...
		$vw_ecommerce_store_custom_css .='@media screen and (max-width:575px) {';
		$vw_ecommerce_store_custom_css .='.scrollup i{';
			$vw_ecommerce_store_custom_css .='display:none !important;';
		$vw_ecommerce_store_custom_css .='} }';
	}
	...
	if($vw_ecommerce_store_topbar_padding_top_bottom != false){
		$vw_ecommerce_store_custom_css .='.lower-header{';
			$vw_ecommerce_store_custom_css .='padding-top: '.esc_html($vw_ecommerce_store_topbar_padding_top_bottom).'; padding-bottom: '.esc_html($vw_ecommerce_store_topbar_padding_top_bottom).';';
		$vw_ecommerce_store_custom_css .='}';
	}
	...
	if($vw_ecommerce_store_sticky_header_padding != false){
		$vw_ecommerce_store_custom_css .='.header-fixed{';
			$vw_ecommerce_store_custom_css .='padding: '.esc_html($vw_ecommerce_store_sticky_header_padding).';';
		$vw_ecommerce_store_custom_css .='}';
	}
	...
	if($vw_ecommerce_store_search_padding_top_bottom != false || $vw_ecommerce_store_search_padding_left_right != false || $vw_ecommerce_store_search_font_size != false || $vw_ecommerce_store_search_border_radius != false){
		$vw_ecommerce_store_custom_css .='.search-box i{';
			$vw_ecommerce_store_custom_css .='padding-top: '.esc_html($vw_ecommerce_store_search_padding_top_bottom).'; padding-bottom: '.esc_html($vw_ecommerce_store_search_padding_top_bottom).';padding-left: '.esc_html($vw_ecommerce_store_search_padding_left_right).';padding-right: '.esc_html($vw_ecommerce_store_search_padding_left_right).';font-size: '.esc_html($vw_ecommerce_store_search_font_size).';border-radius: '.esc_html($vw_ecommerce_store_search_border_radius).'px;';
		$vw_ecommerce_store_custom_css .='}';
	}
	...
	if($vw_ecommerce_store_button_padding_top_bottom != false || $vw_ecommerce_store_button_padding_left_right != false){
		$vw_ecommerce_store_custom_css .='.post-main-box .more-btn a{';
			$vw_ecommerce_store_custom_css .='padding-top: '.esc_html($vw_ecommerce_store_button_padding_top_bottom).'; padding-bottom: '.esc_html($vw_ecommerce_store_button_padding_top_bottom).';padding-left: '.esc_html($vw_ecommerce_store_button_padding_left_right).';padding-right: '.esc_html($vw_ecommerce_store_button_padding_left_right).';';
		$vw_ecommerce_store_custom_css .='}';
	}
	...
	if($vw_ecommerce_store_button_border_radius != false){
		$vw_ecommerce_store_custom_css .='.post-main-box .more-btn a{';
			$vw_ecommerce_store_custom_css .='border-radius: '.esc_html($vw_ecommerce_store_button_border_radius).'px;';
		$vw_ecommerce_store_custom_css .='}';
	}
	...
	if($vw_ecommerce_store_copyright_alingment != false){
		$vw_ecommerce_store_custom_css .='.copyright p{';
			$vw_ecommerce_store_custom_css .='text-align: '.esc_html($vw_ecommerce_store_copyright_alingment).';';
		$vw_ecommerce_store_custom_css .='}';
	}
	...
	if($vw_ecommerce_store_copyright_padding_top_bottom != false){
		$vw_ecommerce_store_custom_css .='#footer-2{';
			$vw_ecommerce_store_custom_css .='padding-top: '.esc_html($vw_ecommerce_store_copyright_padding_top_bottom).'; padding-bottom: '.esc_html($vw_ecommerce_store_copyright_padding_top_bottom).';';
		$vw_ecommerce_store_custom_css .='}';
	}
	...
	if($vw_ecommerce_store_scroll_to_top_font_size != false){
		$vw_ecommerce_store_custom_css .='.scrollup i{';
			$vw_ecommerce_store_custom_css .='font-size: '.esc_html($vw_ecommerce_store_scroll_to_top_font_size).';';
		$vw_ecommerce_store_custom_css .='}';
	}
	...
	if($vw_ecommerce_store_scroll_to_top_padding != false){
		$vw_ecommerce_store_custom_css .='.scrollup i{';
			$vw_ecommerce_store_custom_css .='padding-top: '.esc_html($vw_ecommerce_store_scroll_to_top_padding).';padding-bottom: '.esc_html($vw_ecommerce_store_scroll_to_top_padding).';';
		$vw_ecommerce_store_custom_css .='}';
	}
	...
	if($vw_ecommerce_store_scroll_to_top_width != false){
		$vw_ecommerce_store_custom_css .='.scrollup i{';
			$vw_ecommerce_store_custom_css .='width: '.esc_html($vw_ecommerce_store_scroll_to_top_width).';';
		$vw_ecommerce_store_custom_css .='}';
	}
	...
	if($vw_ecommerce_store_scroll_to_top_height != false){
		$vw_ecommerce_store_custom_css .='.scrollup i{';
			$vw_ecommerce_store_custom_css .='height: '.esc_html($vw_ecommerce_store_scroll_to_top_height).';';
		$vw_ecommerce_store_custom_css .='}';
	}
	...
	if($vw_ecommerce_store_scroll_to_top_border_radius != false){
		$vw_ecommerce_store_custom_css .='.scrollup i{';
			$vw_ecommerce_store_custom_css .='border-radius: '.esc_html($vw_ecommerce_store_scroll_to_top_border_radius).'px;';
		$vw_ecommerce_store_custom_css .='}';
	}
	...
	if($vw_ecommerce_store_social_icon_font_size != false){
		$vw_ecommerce_store_custom_css .='#sidebar .custom-social-icons i, #footer .custom-social-icons i{';
			$vw_ecommerce_store_custom_css .='font-size: '.esc_html($vw_ecommerce_store_social_icon_font_size).';';
		$vw_ecommerce_store_custom_css .='}';
	}
	...
	if($vw_ecommerce_store_social_icon_padding != false){
		$vw_ecommerce_store_custom_css .='#sidebar .custom-social-icons i, #footer .custom-social-icons i{';
			$vw_ecommerce_store_custom_css .='padding: '.esc_html($vw_ecommerce_store_social_icon_padding).';';
		$vw_ecommerce_store_custom_css .='}';
	}
	...
	if($vw_ecommerce_store_social_icon_width != false){
		$vw_ecommerce_store_custom_css .='#sidebar .custom-social-icons i, #footer .custom-social-icons i{';
			$vw_ecommerce_store_custom_css .='width: '.esc_html($vw_ecommerce_store_social_icon_width).';';
		$vw_ecommerce_store_custom_css .='}';
	}
	...
	if($vw_ecommerce_store_social_icon_height != false){
		$vw_ecommerce_store_custom_css .='#sidebar .custom-social-icons i, #footer .custom-social-icons i{';
			$vw_ecommerce_store_custom_css .='height: '.esc_html($vw_ecommerce_store_social_icon_height).';';
		$vw_ecommerce_store_custom_css .='}';
	}
	...
	if($vw_ecommerce_store_social_icon_border_radius != false){
		$vw_ecommerce_store_custom_css .='#sidebar .custom-social-icons i, #footer .custom-social-icons i{';
			$vw_ecommerce_store_custom_css .='border-radius: '.esc_html($vw_ecommerce_store_social_icon_border_radius).'px;';
		$vw_ecommerce_store_custom_css .='}';
	}